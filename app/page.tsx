...
import { HeroParallax } from "@/components/Global/Connect-x-parallax";
...
export default function Home() {
  return (
    <main>
      <Navbar />
      <section className="h-screen w-full bg-neutral-950 rounde-md !overflow-visivble relative flex flex-col items-center antialiased">
